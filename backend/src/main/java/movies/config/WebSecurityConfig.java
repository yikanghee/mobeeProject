...
/*    AuthenticationManager 를 이용하여, 원하는 시점에 로그인이 될 수 있도록 바꿔보자.
    ...
    protected void configure(HttpSecurity http) throws Exception {
            ...
            http
                    ...
                    .antMatchers(HttpMethod.POST, "/api/movies/**").authenticated()
                    .antMatchers(HttpMethod.PUT, "/api/movies/**").authenticated()
                    .antMatchers(HttpMethod.DELETE, "/api/movies/**").authenticated()
